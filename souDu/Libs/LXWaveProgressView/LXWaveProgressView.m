...
#define LXDefaultFirstWaveColor [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:0.3]
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.waveHeight = 15.0;
        self.firstWaveColor = [UIColor redColor];
        self.secondWaveColor = [UIColor redColor];
        self.yHeight = self.bounds.size.height;
        self.speed = 1.0;
        
        self.firstWaveLayer.opacity = 0.1;
        self.secondWaveLayer.opacity = 0.04;
